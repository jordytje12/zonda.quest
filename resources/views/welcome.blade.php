        ...
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="/" class="-m-1.5 p-1.5">
                    <img class="h-8 w-auto" src="/resources/images/jorddev%20discord.jpg" alt="">
                </a>
            </div>
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Over mij</a>
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Portfolio</a>
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Blog</a>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Contact <span aria-hidden="true">&rarr;</span></a>
            </div>
        </nav>
